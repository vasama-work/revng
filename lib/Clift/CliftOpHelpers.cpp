...
bool clift::isValueCategorySignificant(mlir::Value Value) {
  constexpr auto P = &ExpressionOpInterface::reliesOnOperandValueCategory;
  return testValueUsage<P>(Value);
}
